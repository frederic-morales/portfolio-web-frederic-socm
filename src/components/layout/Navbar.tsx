...
export function Navbar() {
  ...
  // 3. Lógica para alternar el idioma
  const toggleLanguage = () => {
    // Obtenemos el idioma actual (limpiando códigos como 'en-US' a 'en')
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button
              ...
              className="p-2 rounded-full bg-secondary hover:bg-secondary/80 transition-colors flex items-center gap-1.5"
