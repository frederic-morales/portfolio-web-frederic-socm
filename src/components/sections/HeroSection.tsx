    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full text-primary text-sm font-medium mb-8 opacity-0 animate-fade-up">
            <Sparkles className="w-4 h-4" />
            Disponible para nuevos proyectos
          </div>

          <h1 className="font-display text-5xl md:text-7xl font-bold tracking-tight mb-6 opacity-0 animate-fade-up stagger-1">
            Hola, soy{" "}
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed opacity-0 animate-fade-up stagger-2">
