            ...
            <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
              <div className="shrink-0 opacity-0 animate-fade-up">
                <div className="relative">
                  ...
                  <img
                    src={profilePhoto}
                    alt={t("aboutPage.profilePhotoAlt")}
              ...
              <div className="text-center md:text-left">
                <h1 className="font-display text-4xl md:text-5xl font-bold mb-6 opacity-0 animate-fade-up stagger-1">
                  {t("aboutPage.titlePrefix")} <span className="text-gradient">{t("aboutPage.titleSuffix")}</span>
                </h1>
        ...
        <section className="py-16 bg-secondary/30">
          <div className="container mx-auto px-6">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="font-display text-2xl font-bold">{t("aboutPage.sections.experience")}</h2>
            </div>
              ...
              {experiences.map((exp) => (
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 mb-3">
                    <h3 className="font-display font-semibold text-lg">{t(`experiencesData.${exp.id}.title`)}</h3>
                    <span className="text-sm text-primary font-medium">{t(`experiencesData.${exp.id}.period`)}</span>
                  </div>
                  <p className="text-muted-foreground font-medium mb-2">{exp.company}</p>
                  <p className="text-muted-foreground text-sm">{t(`experiencesData.${exp.id}.description`)}</p>
                </a>
              ))}
            </div>
          </div>
        ...
        <section className="py-16">
          <div className="container mx-auto px-6">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="font-display text-2xl font-bold">{t("aboutPage.sections.technologies")}</h2>
            </div>
        ...
        <section className="py-16 bg-secondary/30">
          <div className="container mx-auto px-6">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="font-display text-2xl font-bold">{t("aboutPage.sections.education")}</h2>
            </div>
              {education.map((institute) => (
                <div key={institute.id} className="p-6 bg-card rounded-xl border border-border mb-5">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 mb-3">
                    <h3 className="font-display font-semibold text-lg">
                      {t(`educationData.${institute.id}.title`)}
                    </h3>
                    <span className="text-sm text-primary font-medium">{institute.period}</span>
                  </div>
                  <p className="text-muted-foreground">{t(`educationData.${institute.id}.description`)}</p>
                </div>
              ))}
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto px-6">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="font-display text-2xl font-bold">{t("aboutPage.sections.moreAboutMe")}</h2>
            </div>
            <p className="text-muted-foreground max-w-2xl leading-relaxed">
              {t("aboutPage.personal")}
            </p>
          </div>
        </section>
      </main>
